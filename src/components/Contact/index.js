...
return (
    <section>
        ...
        <Row>
            <Col lg={3} md={12}>
            <a href="https://github.com/benyvue"><img src="https://img.icons8.com/doodle/100/000000/github--v1.png" alt="github-logo" class="icon"/></a><p class="icon-text">github</p>
            </Col>

            <Col lg={3} md={12}>
            <a href="https://www.linkedin.com/in/ben-vue-710205b6/"><img src="https://img.icons8.com/doodle/100/000000/linkedin--v2.png" alt="linkedin-logo" class="icon"/></a><p class="icon-text">linkedin</p>
            </Col>

            <Col lg={3} md={12}>
            <a href="mailto:benyvue@gmail.com"><img src="https://img.icons8.com/doodle/120/000000/new-post.png" alt="mail-logo"/></a><p class="icon-text">email</p>
            </Col>
        ...
        <p>
          <span className="school-name">University of Minnesota</span><br></br>
          Full Stack Boot Camp - Certification 
          <br></br>
          <br></br>
          <span className="school-name">Saint John's University MN</span><br></br>
          Nutrition Dietetics Focus - BA
          <br></br>
          <br></br>
          <span className="school-name">Saint Paul College</span><br></br>
          Computer Science Generals
        </p>
        </Col>
        </Row>
        </div>
